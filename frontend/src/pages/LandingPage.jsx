...
// import PageLogin from "./LoginPage.jsx";
...
//       {showLogin && <PageLogin onClose={() => setShowLogin(false)} />}
//       {showSignup && <PageSignup onClose={() => setShowSignup(false)} />}
//     </div>
//   );
// }
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-start mt-20 pl-8 md:pl-16 h-full">
        ...
        <button className="glass glass-interactive glass-text rounded-full px-4 py-1.5 text-sm font-normal text-xl mt-5" onClick={() => navigate("/signup")}> Get Started 
        </button>
      </div>
    </div>
  );
